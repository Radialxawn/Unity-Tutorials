...
public class UIController : MonoBehaviour {
	...
	public void Initialize() {
		...
		GameController.OnScore += OnScore;
	...
	private void OnScore() {
		inGameScoreText.text = GameController.Score.ToString();
	}
	...
	private void ShowGameOver() {
		...
		gameOverBestScoreText.text = (GameController.In2DMode ? PlayerData.BestScore.Mode2D.Get() : PlayerData.BestScore.Mode3D.Get()).ToString();
		mainMenu.SetActive(false);
		inGame.SetActive(false);
